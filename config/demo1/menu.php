...
$menu_vertical[] = ["title" => "sqdqs","sub" => ["class" => "menu-sub-accordion menu-active-bg" , "items" => $system_sub_items ],  'attributes' => array("data-kt-menu-trigger" => "click"),'classes'    => array('item' => 'menu-accordion'),  'icon' => [ 'svg'  => theme()->getSvgIcon("demo1/media/icons/duotune/general/gen025.svg", "svg-icon-2"),'font' => '<i class="bi bi-layers fs-3"></i>']];
