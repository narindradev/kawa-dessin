            ...
            <div class="form-group">
                <div class="mb-10">
                    ...
                    <input type="text" value="{{ '' }}" autocomplete="off" name="first_name"
                        class="form-control form-control-solid" placeholder="@lang('lang.first_name')"
            ...
            <div class="form-group">
                <div class="mb-10">
                    ...
                    <input type="text" value="{{ '' }}" autocomplete="off" name="email"
                        class="form-control form-control-solid" placeholder="@lang('lang.email')"
                        data-rule-required="true" data-msg-required="@lang('lang.required_input')"
                        data-rule-email="true" data-msg-email="@lang('lang.required_input_type_email')" />
                </div>
            </div>
            <div class="form-group">
                <div class="mb-10">
                    ...
                    <div class="input-group">
                        <select name="user_type_id" data-dropdown-parent="#ajax-modal" data-rule-required="true"
                            data-hide-search="true" data-msg-required="@lang('lang.required_input')"
                            class="form-select  form-select-solid" data-control="select2"
                            data-placeholder="@lang('lang.function')">
                            <option value="0" disabled selected>-- @lang('lang.function') --</option>
                            @foreach ($user_type as $type)
                                <option value="{{ get_array_value($type, 'value') }}">
                                    {{ get_array_value($type, 'text') }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
